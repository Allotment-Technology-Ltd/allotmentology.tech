    ...
    <div className="space-y-8">
      ...
      <div className="rounded-lg border border-zinc-800 bg-zinc-950/35 px-4 py-4 text-sm text-zinc-400">
        ...
        <p className="mt-1 leading-relaxed">
          <strong className="font-medium text-zinc-300">Mitchell</strong> is the
          grant writer: intake (angle, risks, scaffold pointers) and Q&amp;A
          answers for form questions - on each{" "}
          <Link
            href="/opportunities"
            className="text-sky-400 underline-offset-2 hover:text-sky-300 hover:underline"
          >
          ...
          . <strong className="font-medium text-zinc-300">Collateral</strong> has
          Improve / Expand / Shorten;{" "}
          <strong className="font-medium text-zinc-300">submission packs</strong>{" "}
          have the drafting agent. All use your key from{" "}
          <Link
